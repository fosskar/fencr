...
let
  ...
  sandboxRow =
    ...
    }, StateDir: "${core.stateDirOf name}", CheckpointDir: "${core.checkpointDirOf name}", Image: "${core.stateImageOf name}", APISocket: "${core.apiSocketOf name}", JumpUser: "${core.jumpUserOf name}", Keep: ${toString cfg.checkpoints.keep}, SSH: ${
